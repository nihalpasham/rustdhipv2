    ...
    pub fn get_parameters(&self) -> &'a [HIPParameter<&[u8]>] {
        ...
        while has_more_params {
            ...
            match param_type as usize {
                ...
                (field::HIP_DH_GROUP_LIST_TYPE)          => {param_list[idx] = DHGroupListParameter::new_unchecked(
...
pub trait FixedParameterFields {
    // fn new_unchecked(self);
    fn get_critical_bit(&self) -> u16;
...
pub struct R1CounterParam<T: AsRef<[u8]>> {
...
impl<T: AsRef<[u8]> + AsMut<[u8]>> DHGroupListParameter<T> {
    ...
    /// Imbue a raw octet buffer with DHGroupListParameter packet structure.
    #[inline]
